...
저는 실제 운영 환경에서 RackNerd를 사용합니다. 이 가이드를 참고해 본인에게 맞는 구성을 선택하세요.

**[RackNerd 살펴보고 가이드의 지속적인 업데이트 지원하기](https://my.racknerd.com/aff.php?aff=21220)**
...
먼저 위의 RackNerd 지원 링크에서 본인 계정을 등록하고 로그인하세요. 기존 계정은 바로 로그인하고, 적합한 VPS가 있으면 구매를 건너뛰세요. 계정 등록만으로 서버가 구매되지는 않습니다. 요금제와 결제를 확인하고 개통된 뒤 배포를 시작하세요. 계정 정보는 직접 입력하고 인증 정보는 비공개로 보관하세요.
